...
public interface IParadaRepository
{
    ...
    Task<string?> BuscarNomeAsync(Guid paradaId, CancellationToken cancellationToken);
    Task<IReadOnlyList<ParadaItinerarioPosicaoDTO>> ListarPosicoesPorItinerariosAsync(
        Guid paradaId,
