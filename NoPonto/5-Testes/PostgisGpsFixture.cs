    ...
    public async Task InitializeAsync()
    {
        ...
        try
        {
            ...
            await using var seed = DataSource.CreateCommand("""
                ...
                INSERT INTO "Paradas" VALUES (@parada,'Parada controlada',ST_SetSRID(ST_MakePoint(-43.195,-22.9),4326));
                INSERT INTO "ParadasItinerario" VALUES (@parada,@r1,0.75);
                """);
            foreach (var pair in new (string, Guid)[] { ("l1",linha1),("l2",linha2),("s1",sentido1),("s2",sentido2),
                ("r1",R1),("r2",R2),("volta",Volta),("outra",OutraLinha),("diag",Diagonal),("parada",Guid.NewGuid()),
